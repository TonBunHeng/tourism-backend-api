...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 13. Businesses (Owned by Business Owner)
        $b1 = Business::create([
            ...
            'category_id' => $cDining->id ?? null,
            'province_id' => $pSiemReap->id ?? null,
        ...
        BusinessImage::create([
            ...
            'caption' => 'Main Dining Hall & Courtyard',
            'is_cover' => true,
            'display_order' => 1,
        ]);
        BusinessImage::create([
            ...
            'caption' => 'Royal Khmer Tasting Set',
            'is_cover' => false,
            'display_order' => 2,
        ]);
        ...
        BusinessService::create([
            'business_id' => $b1->id,
            'name' => 'Royal Khmer 5-Course Dinner Set',
        ...
        BusinessService::create([
            'business_id' => $b1->id,
            'name' => 'Khmer Cooking Class with Market Tour',
            'description' => 'Morning market exploration followed by interactive 3-dish cooking session.',
            'price' => 28.00,
            'currency' => 'USD',
        ...
        // Second business: Pending verification
        $b2 = Business::create([
            'owner_id' => $businessOwner->id,
            ...
            'category_id' => $cAdventure->id ?? null,
            'province_id' => $pPhnomPenh->id ?? null,
